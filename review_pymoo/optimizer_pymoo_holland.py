...
if __name__ == "__main__":
    ...
    # Save data for plots 
    np.save('./npy_files/holland'+ WOFOST.user_parameters['crop_name']+'irrifation_ammount', WOFOST.container_of_irrigation_amount)
    np.save('./npy_files/holland'+ WOFOST.user_parameters['crop_name']+'water_loss', WOFOST.container_of_mean_water_loss)
    np.save('./npy_files/holland'+ WOFOST.user_parameters['crop_name']+'crop_yields', WOFOST.container_of_mean_yields)
    np.save('./npy_files/holland'+ WOFOST.user_parameters['crop_name']+'function_values_for_paretto', mdt)
    np.save('./npy_files/holland'+ WOFOST.user_parameters['crop_name']+'optimal_solutions', res.X)
