...
if __name__ == "__main__":
    ...
    np.save(os.path.join(path_to_folder, WOFOST.user_parameters['crop_name']+'_irrigation_ammount'), WOFOST.container_of_irrigation_amount)
    np.save(os.path.join(path_to_folder, WOFOST.user_parameters['crop_name']+'_crop_yields'), WOFOST.container_of_mean_yields)
    np.save(os.path.join(path_to_folder, WOFOST.user_parameters['crop_name']+'_water_loss'), WOFOST.container_of_mean_water_loss)
